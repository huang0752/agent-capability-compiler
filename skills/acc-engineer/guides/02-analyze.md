...
10. 只推荐一个依赖已就绪的大领域供下一阶段激活；其余领域保持未激活并保留完整候选。缺写沙箱授权或安全 Evidence 的 Action 候选保持 `undetermined/blocked_on_evidence`，不允许以 excluded、ineligible 或“本轮只做 Read”从 ledger 消失。
