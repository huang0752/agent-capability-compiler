...
12. 解释每个 intent 的 merge/split/compose Evidence、blocked boundary、route coverage 和 `IntentRelationship`；报告最终 Capability/MCP 数量为派生 observation，并明确没有固定工具配额、route-per-tool 默认或由用户指定数量。
